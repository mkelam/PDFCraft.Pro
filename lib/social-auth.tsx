...
export class SocialAuth {
   ...
   */
  static async signInWithLinkedIn(): Promise<SocialAuthResult> {
    try {
   ...
   */
  static async signOutSocial(): Promise<void> {
    try {
      await signOut({
        redirect: false,
        callbackUrl: '/'
  ...
  /**
   * Get provider name for current session
   */
  static async getProvider(): Promise<string | null> {
    try {
      const session = await getSession();
      return (session as any)?.provider || null;
    } catch (error) {
...
export const socialProviders = [
  {
    ...
    action: SocialAuth.signInWithGoogle
  },
  {
    id: 'facebook',
    name: 'Facebook',
    ...
    action: SocialAuth.signInWithFacebook
  },
  {
    id: 'linkedin',
    name: 'LinkedIn',
    ...
    action: SocialAuth.signInWithLinkedIn
  }
];
